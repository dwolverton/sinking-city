export const BOARD_TILE_COUNT:number = 36;
export const OUT_OF_BOUNDS_LOCATIONS:Set<number> = new Set();
OUT_OF_BOUNDS_LOCATIONS.add(0);
OUT_OF_BOUNDS_LOCATIONS.add(1);
OUT_OF_BOUNDS_LOCATIONS.add(4);
OUT_OF_BOUNDS_LOCATIONS.add(5);
OUT_OF_BOUNDS_LOCATIONS.add(6);
OUT_OF_BOUNDS_LOCATIONS.add(11);
OUT_OF_BOUNDS_LOCATIONS.add(24);
OUT_OF_BOUNDS_LOCATIONS.add(29);
OUT_OF_BOUNDS_LOCATIONS.add(30);
OUT_OF_BOUNDS_LOCATIONS.add(31);
OUT_OF_BOUNDS_LOCATIONS.add(34);
OUT_OF_BOUNDS_LOCATIONS.add(35);
